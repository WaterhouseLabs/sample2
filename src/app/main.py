...
# sidebar
def cs_sidebar():
    st.sidebar.markdown('''[<img src='data:image/png;base64,{}' class='img-fluid' width=32 height=32>](https://streamlit.io/)'''.format(img_to_bytes("app/logomark_website.png")), unsafe_allow_html=True)
...
pip install streamlit-nightly --upgrade
    ...
    st.sidebar.markdown('''<small>[Global CaaS docs](https://hosted-apps-us.pwclabs.pwcglb.com/docs/) | [Cheat sheet v1.25.0](https://github.com/daniellewisDL/streamlit-cheat-sheet)  | Aug 2023 | [Daniel Lewis](https://daniellewisdl.github.io/)</small>''', unsafe_allow_html=True)
...
''')
    ...
    # Returns a list of blobs associated to the Azure Blob Storage from the container associated with the ENGAGEMENT_ID
    blob_client = AzureBlobStorageService(
        Settings.STORAGE_ACCOUNT_NAME,
        Settings.AZURE_BLOB_SAS_TOKEN,
        Settings.ENGAGEMENT_ID
    )

    col2.subheader("Your workspace files:")
    col2.write([file['name'] for file in blob_client.get_blob_list()])
